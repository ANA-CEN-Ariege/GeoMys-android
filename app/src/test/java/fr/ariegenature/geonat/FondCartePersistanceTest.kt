...
import fr.ariegenature.geonat.ui.FondCarte
import fr.ariegenature.geonat.ui.chargerFondCarte
import fr.ariegenature.geonat.ui.enregistrerFondCarte
...
class FondCartePersistanceTest {
    ...
    fun valeur_corrompue_retombe_sur_le_defaut() {
        ctx.getSharedPreferences("GeoNat_prefs", Context.MODE_PRIVATE)
