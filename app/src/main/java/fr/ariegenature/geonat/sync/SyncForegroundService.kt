...
package fr.ariegenature.geonat.sync
...
import fr.ariegenature.geonat.ui.MainActivity
 ...
 *
 *  Calqué sur [fr.ariegenature.geonat.location.LocationForegroundService]. */
class SyncForegroundService : Service() {

    companion object {
        const val CHANNEL_ID = "GeoNat_sync"
    ...
    private fun buildNotification(texte: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("GeoNat — synchronisation")
